...
namespace Projeto01.Domain.Services
{
    public class ContatoDomainService : IContatoDomainService
    {
        ...
        public async Task CreateAsync(Contato entity)
        {
            ...
            #region O telefone deve ser único
            if (_unitOfWork.ContatoRepository.GertByTelefone(entity.Telefone) != null)
        ...
        public async Task UpdateAsync(Contato entity)
        {
            ...
            var contatoByTelefone = _unitOfWork.ContatoRepository.GertByTelefone(entity.Telefone);
